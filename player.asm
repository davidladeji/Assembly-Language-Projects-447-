...
enter
	...
	bne t0, 0, _decrement_deadframes

	lw t0, player_fire_time
	ble t0, 0, _skip_fire_time_sub
	...
	_decrement_deadframes:
		lw t0, player_deadframes
		sub t0, t0, 1
		sw t0, player_deadframes

		bne t0, 0, _exit_player_update

		lw t0, player_lives
		ble t0, 0, _lose_game_label
...
enter
	...
	_exit_accel:
		li t0, KEY_B
		and t0, t0, v0
		beq t0, 0, _exit_player_check_input

		jal player_fire

	_exit_player_check_input:
leave
...
enter
	lw t0, player_accel
	beq t0, 0, _exit_player_update_thrust
...
enter
    ...
    lw t0, player_lives
    beq t0, 0, _exit_player_damage

    #li t0, PLAYER_MAX_HEALTH
    #sw t0, player_health

    j _exit_player_damage
